...
export const searchResultMock: PlaceAutoCompletePrediction[] = [
  {
    Version: 1,
    Key: '324505',
    Type: 'City',
  ...
  },
  {
    ...
    AdministrativeArea: {
      ID: 'KZY',
      LocalizedName: 'Kyzylorda Region',
    },
  },
  {
    Version: 1,
